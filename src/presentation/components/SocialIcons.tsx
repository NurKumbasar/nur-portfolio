// Emoji yerine SVG ikon kuralı: GitHub/LinkedIn/E-posta için basit
// çizim (path) verileri, fill="currentColor" ile buton rengini otomatik
// alır. Hero ve Footer ikisi de bu üçünü kullandığı için tek yerde.
...
export function MailIcon() {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
      <rect x="2.25" y="4.75" width="19.5" height="14.5" rx="1.75" />
      <path strokeLinecap="round" strokeLinejoin="round" d="m3 6 9 6.5L21 6" />
    </svg>
  )
}
